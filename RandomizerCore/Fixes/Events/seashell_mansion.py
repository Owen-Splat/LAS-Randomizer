...
class SeashellMansionEventFixes:
    ...
    def __int__(self, mod_generator) -> None:
        flow = mod_generator.file_manager.readFile('ShellMansionPresent.bfevfl')
        self.changeRewards(flow.flowchart)
        mod_generator.file_manager.writeFile('ShellMansionPresent.bfevfl', flow)
