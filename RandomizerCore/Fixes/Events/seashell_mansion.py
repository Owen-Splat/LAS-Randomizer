...
class SeashellMansionEventFixes:
    """Make events for progressive items and add custom events for other items, such as traps"""
    ...
    def changeRewards(self, flowchart):
        ...
        shield_get = self.parent.item_get_manager.get(flowchart, 'Shield', -1, None, 'Event0')
        ...
        bracelet_get = self.parent.item_get_manager.get(flowchart, 'PowerBraceletLv1', -1, None, 'Event0')
        ...
        powder_capacity_get = self.parent.item_get_manager.get(flowchart, 'MagicPowder_MaxUp', -1, None, 'Event0')
        ...
        bomb_capacity_get = self.parent.item_get_manager.get(flowchart, 'Bomb_MaxUp', -1, None, 'Event0')
        ...
        arrow_capacity_get = self.parent.item_get_manager.get(flowchart, 'Arrow_MaxUp', -1, None, 'Event0')
        ...
        red_tunic_get = self.parent.item_get_manager.get(flowchart, 'ClothesRed', -1, None, 'Event0')
        ...
        blue_tunic_get = self.parent.item_get_manager.get(flowchart, 'ClothesBlue', -1, None, 'Event0')
        ...
        cello_get = self.parent.item_get_manager.get(flowchart, 'FullMoonCello', -1, None, 'Event0')
        ...
        harp_get = self.parent.item_get_manager.get(flowchart, 'SurfHarp', -1, None, 'Event0')
        ...
        yoshi_get = self.parent.item_get_manager.get(flowchart, 'YoshiDoll', -1, None, 'Event0')
        ...
        ribbon_get = self.parent.item_get_manager.get(flowchart, 'Ribbon', -1, None, 'Event0')
        ...
        dog_food_get = self.parent.item_get_manager.get(flowchart, 'DogFood', -1, None, 'Event0')
        ...
        bananas_get = self.parent.item_get_manager.get(flowchart, 'Bananas', -1, None, 'Event0')
        ...
        stick_get = self.parent.item_get_manager.get(flowchart, 'Stick', -1, None, 'Event0')
        ...
        honeycomb_get = self.parent.item_get_manager.get(flowchart, 'Honeycomb', -1, None, 'Event0')
        ...
        pineapple_get = self.parent.item_get_manager.get(flowchart, 'Pineapple', -1, None, 'Event0')
        ...
        hibiscus_get = self.parent.item_get_manager.get(flowchart, 'Hibiscus', -1, None, 'Event0')
        ...
        letter_get = self.parent.item_get_manager.get(flowchart, 'Letter', -1, None, 'Event0')
        ...
        broom_get = self.parent.item_get_manager.get(flowchart, 'Broom', -1, None, 'Event0')
        ...
        hook_get = self.parent.item_get_manager.get(flowchart, 'FishingHook', -1, None, 'Event0')
        ...
        necklace_get = self.parent.item_get_manager.get(flowchart, 'PinkBra', -1, None, 'Event0')
        ...
        scale_get = self.parent.item_get_manager.get(flowchart, 'MermaidsScale', -1, None, 'Event0')
        ...
        lens_get = self.parent.item_get_manager.get(flowchart, 'MagnifyingLens', -1, None, 'Event0')
        ...
        zap_get = self.parent.item_get_manager.get(flowchart, 'ZapTrap', -1, None, 'Event0')
        ...
        drown_get = self.parent.item_get_manager.get(flowchart, 'DrownTrap', -1, None, 'Event0')
        ...
        squish_get = self.parent.item_get_manager.get(flowchart, 'SquishTrap', -1, None, 'Event0')
        ...
        deathball_get = self.parent.item_get_manager.get(flowchart, 'DeathballTrap', -1, None, 'Event0')
        ...
        quake_get = self.parent.item_get_manager.get(flowchart, 'QuakeTrap', -1, None, 'Event0')
        ...
        bomb_get = self.parent.item_get_manager.get(flowchart, 'Bomb', -1, None, 'Event0')
        ...
        powder_get = self.parent.item_get_manager.get(flowchart, 'MagicPowder', -1, None, 'Event0')
        ...
        bottle_get = self.parent.item_get_manager.get(flowchart, 'Bottle', 1, None, 'Event0')
...
def makeEventChanges(flowchart, placements):
    ...
    sword_check1 = event_tools.createSwitchEvent(flowchart, 'EventFlags', 'CheckFlag', {'symbol': "SwordFoundFlag"}, {0: 'Event65', 1: 'Event64'})
    ...
    if placements['40-seashell-reward'] != 'sword':
        sword_check2 = event_tools.createSwitchEvent(flowchart, 'EventFlags', 'CheckFlag', {'symbol': "SwordFoundFlag"}, {0: 'Event48', 1: 'Event47'})
    ...
    if placements['40-seashell-reward'] == 'sword':
        ...
        sword_check3 = event_tools.createSwitchEvent(flowchart, 'EventFlags', 'CheckFlag', {'symbol': "SwordFoundFlag"}, {0: early_give_sword1, 1: early_give_sword2})
