...
class ChestRandomizer:
    ...
    def writeChestEvent(self):
        ...
        sword_get = item_get.insertItemGetAnimation(flow.flowchart, 'SwordLv1', -1 , None, auto_save)
        ...
        shield_get = item_get.insertItemGetAnimation(flow.flowchart, 'Shield', -1, None, auto_save)
        ...
        bracelet_get = item_get.insertItemGetAnimation(flow.flowchart, 'PowerBraceletLv1', -1, None, auto_save)
        ...
        red_tunic_get = item_get.insertItemGetAnimation(flow.flowchart, 'ClothesRed', -1, None, auto_save)
        ...
        blue_tunic_get = item_get.insertItemGetAnimation(flow.flowchart, 'ClothesBlue', -1, None, auto_save)
        ...
        zap_get = item_get.insertItemGetAnimation(flow.flowchart, 'ZapTrap', -1, None, auto_save)
        ...
        drown_get = item_get.insertItemGetAnimation(flow.flowchart, 'DrownTrap', -1, None, auto_save)
        ...
        squish_get = item_get.insertItemGetAnimation(flow.flowchart, 'SquishTrap', -1, None, auto_save)
        ...
        deathball_get = item_get.insertItemGetAnimation(flow.flowchart, 'DeathballTrap', -1, None, auto_save)
        ...
        quake_get = item_get.insertItemGetAnimation(flow.flowchart, 'QuakeTrap', -1, None, auto_save)
