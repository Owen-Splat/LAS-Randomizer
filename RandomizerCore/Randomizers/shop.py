...
#     item_get_manager.insertItemGetAnimation(flowchart, item_key, item_index, 'Event53', 'Event43')
...
#     item_get_manager.insertItemGetAnimation(flowchart, item_key, item_index, 'Event17', 'Event151')
...
#     item_get_manager.insertItemGetAnimation(flowchart, item_key, item_index, 'Event122', set_flag)
...
#     ], None)
#     give_heart = item_get_manager.insertItemGetAnimation(flowchart,
...
#     ], check_heart)
#     give_bow = item_get_manager.insertItemGetAnimation(flowchart,
...
#     ], check_bow)
#     give_shovel = item_get_manager.insertItemGetAnimation(flowchart,
