...
def makePrizesStack(flowchart, placements, item_defs, rom_path):
    ...
    item_get.insertItemGetAnimation(flowchart, item_defs[placements['rapids-race-45']]['item-key'], item_index, 'Event42', 'Event88', canHurtPlayer=False)
    ...
    get35 = item_get.insertItemGetAnimation(flowchart, item_defs[placements['rapids-race-35']]['item-key'], item_index, None, 'Event86', canHurtPlayer=False)
    ...
    get30 = item_get.insertItemGetAnimation(flowchart, item_defs[placements['rapids-race-30']]['item-key'], item_index, None, 'Event85', canHurtPlayer=False)
