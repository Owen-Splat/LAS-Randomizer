...
def shuffleEnemyActors(room_data, folder: str, file: str, enemy_ids: dict, change_size: bool, rand_state: tuple):
    """"""
    ...
    for e, act in enumerate(room_data.actors):
        if act.type in total_ids: # check for enemy actors
            if e not in excluded_actors:
