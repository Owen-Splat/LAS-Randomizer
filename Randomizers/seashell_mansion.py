...
def changeRewards(flowchart, treasure_flowchart):
    ...
    drown_check = event_tools.createSwitchEvent(flowchart, 'FlowControl', 'CompareString',
        {'value1': event_tools.findEvent(treasure_flowchart, 'Event33').data.params.data['value1'], 'value2': 'DrownTrap'},
    ...
    squish_check = event_tools.createSwitchEvent(flowchart, 'FlowControl', 'CompareString',
        {'value1': event_tools.findEvent(treasure_flowchart, 'Event33').data.params.data['value1'], 'value2': 'SquishTrap'},
    ...
    deathball_check = event_tools.createSwitchEvent(flowchart, 'FlowControl', 'CompareString',
        {'value1': event_tools.findEvent(treasure_flowchart, 'Event33').data.params.data['value1'], 'value2': 'DeathballTrap'},
