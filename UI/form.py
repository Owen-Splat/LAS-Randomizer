...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QRect(10, 109, 731, 177))
        sizePolicy2.setHeightForWidth(self.groupBox.sizePolicy().hasHeightForWidth())
        self.groupBox.setSizePolicy(sizePolicy2)
        self.groupBox.setMinimumSize(QSize(731, 176))
        self.groupBox.setAlignment(Qt.AlignCenter)
        self.groupBox.setFlat(False)
        self.chestsCheck = QCheckBox(self.groupBox)
        self.chestsCheck.setObjectName(u"chestsCheck")
        self.chestsCheck.setGeometry(QRect(10, 34, 173, 21))
        self.fishingCheck = QCheckBox(self.groupBox)
        self.fishingCheck.setObjectName(u"fishingCheck")
        self.fishingCheck.setGeometry(QRect(10, 68, 173, 21))
        self.rapidsCheck = QCheckBox(self.groupBox)
        self.rapidsCheck.setObjectName(u"rapidsCheck")
        self.rapidsCheck.setGeometry(QRect(10, 102, 173, 21))
        self.dampeCheck = QCheckBox(self.groupBox)
        self.dampeCheck.setObjectName(u"dampeCheck")
        self.dampeCheck.setGeometry(QRect(10, 136, 173, 21))
        self.giftsCheck = QCheckBox(self.groupBox)
        self.giftsCheck.setObjectName(u"giftsCheck")
        self.giftsCheck.setGeometry(QRect(189, 34, 173, 21))
        self.bossCheck = QCheckBox(self.groupBox)
        self.bossCheck.setObjectName(u"bossCheck")
        self.bossCheck.setGeometry(QRect(189, 102, 173, 21))
        self.miscellaneousCheck = QCheckBox(self.groupBox)
        self.miscellaneousCheck.setObjectName(u"miscellaneousCheck")
        self.miscellaneousCheck.setGeometry(QRect(189, 136, 173, 21))
        self.horizontalSlider = QSlider(self.groupBox)
        self.horizontalSlider.setObjectName(u"horizontalSlider")
        self.horizontalSlider.setGeometry(QRect(548, 105, 111, 22))
        font2 = QFont()
        ...
        self.label_6.setGeometry(QRect(548, 68, 111, 23))
        sizePolicy2.setHeightForWidth(self.label_6.sizePolicy().hasHeightForWidth())
        self.label_6.setSizePolicy(sizePolicy2)
        self.label_6.setMinimumSize(QSize(75, 23))
        ...
        self.heartsCheck.setGeometry(QRect(369, 34, 173, 21))
        font3 = QFont()
        font3.setPointSize(9)
        font3.setStrikeOut(False)
        self.heartsCheck.setFont(font3)
        ...
        self.tradeGiftsCheck.setGeometry(QRect(189, 68, 173, 21))
        font4 = QFont()
        font4.setPointSize(9)
        font4.setStrikeOut(True)
        self.tradeGiftsCheck.setFont(font4)
        self.tradeGiftsCheck.setStyleSheet(u"color: rgb(80, 80, 80);")
        self.tradeGiftsCheck.setCheckable(False)
        ...
        self.seashellsCheck.setGeometry(QRect(369, 68, 173, 21))
        ...
        self.shopCheck.setGeometry(QRect(369, 102, 173, 21))
        self.shopCheck.setFont(font4)
        self.shopCheck.setStyleSheet(u"color: rgb(80, 80, 80);")
        self.shopCheck.setCheckable(False)
        self.instrumentCheck = QCheckBox(self.groupBox)
        self.instrumentCheck.setObjectName(u"instrumentCheck")
        self.instrumentCheck.setEnabled(True)
        self.instrumentCheck.setGeometry(QRect(369, 136, 173, 21))
        self.instrumentCheck.setFont(font3)
        self.instrumentCheck.setCheckable(True)
        self.groupBox_2 = QGroupBox(self.tab)
        self.groupBox_2.setObjectName(u"groupBox_2")
        self.groupBox_2.setGeometry(QRect(10, 300, 731, 176))
        sizePolicy2.setHeightForWidth(self.groupBox_2.sizePolicy().hasHeightForWidth())
        self.groupBox_2.setSizePolicy(sizePolicy2)
        self.groupBox_2.setMinimumSize(QSize(731, 176))
        self.groupBox_2.setAlignment(Qt.AlignCenter)
        self.groupBox_2.setFlat(False)
        self.bookCheck = QCheckBox(self.groupBox_2)
        self.bookCheck.setObjectName(u"bookCheck")
        self.bookCheck.setGeometry(QRect(10, 34, 173, 21))
        self.bombsCheck = QCheckBox(self.groupBox_2)
        self.bombsCheck.setObjectName(u"bombsCheck")
        self.bombsCheck.setGeometry(QRect(189, 34, 173, 21))
        self.trendyCheck = QCheckBox(self.groupBox_2)
        self.trendyCheck.setObjectName(u"trendyCheck")
        self.trendyCheck.setGeometry(QRect(10, 68, 173, 21))
        self.farmingCheck = QCheckBox(self.groupBox_2)
        self.farmingCheck.setObjectName(u"farmingCheck")
        self.farmingCheck.setGeometry(QRect(369, 34, 173, 21))
        self.stealingCheck = QCheckBox(self.groupBox_2)
        self.stealingCheck.setObjectName(u"stealingCheck")
        self.stealingCheck.setGeometry(QRect(189, 68, 173, 21))
        self.vanillaCheck = QCheckBox(self.groupBox_2)
        self.vanillaCheck.setObjectName(u"vanillaCheck")
        self.vanillaCheck.setGeometry(QRect(548, 34, 173, 21))
        self.lessFishingCheck = QCheckBox(self.groupBox_2)
        self.lessFishingCheck.setObjectName(u"lessFishingCheck")
        self.lessFishingCheck.setGeometry(QRect(369, 68, 173, 21))
        self.spoilerCheck = QCheckBox(self.groupBox_2)
        self.spoilerCheck.setObjectName(u"spoilerCheck")
        self.spoilerCheck.setGeometry(QRect(548, 136, 173, 21))
        self.spoilerCheck.setCheckable(True)
        self.lensCheck = QCheckBox(self.groupBox_2)
        self.lensCheck.setObjectName(u"lensCheck")
        self.lensCheck.setEnabled(True)
        self.lensCheck.setGeometry(QRect(548, 68, 173, 21))
        self.lensCheck.setCheckable(True)
        self.loadingCheck = QCheckBox(self.groupBox_2)
        self.loadingCheck.setObjectName(u"loadingCheck")
        self.loadingCheck.setEnabled(True)
        self.loadingCheck.setGeometry(QRect(10, 136, 173, 21))
        self.loadingCheck.setFont(font4)
        self.loadingCheck.setStyleSheet(u"color: rgb(80, 80, 80);")
        self.loadingCheck.setCheckable(False)
        self.musicCheck = QCheckBox(self.groupBox_2)
        self.musicCheck.setObjectName(u"musicCheck")
        self.musicCheck.setEnabled(True)
        self.musicCheck.setGeometry(QRect(189, 136, 173, 21))
        self.musicCheck.setFont(font3)
        self.musicCheck.setCheckable(True)
        self.kanaletCheck = QCheckBox(self.groupBox_2)
        self.kanaletCheck.setObjectName(u"kanaletCheck")
        self.kanaletCheck.setGeometry(QRect(10, 102, 173, 21))
        self.songs_Check = QCheckBox(self.groupBox_2)
        self.songs_Check.setObjectName(u"songs_Check")
        self.songs_Check.setGeometry(QRect(189, 102, 173, 21))
        self.songs_Check.setFont(font4)
        self.songs_Check.setStyleSheet(u"color: rgb(80, 80, 80);")
        self.songs_Check.setCheckable(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Where can items be located?", None))
#if QT_CONFIG(tooltip)
        self.chestsCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.chestsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether chests found in overworld and caves can contain progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.fishingCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Mabe Fishing prizes can contain progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.rapidsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Rapids Race prizes as well as the items inside can contain progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.dampeCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Damp\u00e9 prizes can contain progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.giftsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether free gifts from NPCs can contain progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(whatsthis)
        self.miscellaneousCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the miscellaneous standing items (sword, mushroom, ocarina, bird key) can be progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
#endif // QT_CONFIG(whatsthis)
        self.miscellaneousCheck.setText(QCoreApplication.translate("MainWindow", u"Miscellaneous", None))
#if QT_CONFIG(whatsthis)
        self.horizontalSlider.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Seashell Mansion prizes can contain progress items", None))
#endif // QT_CONFIG(whatsthis)
#if QT_CONFIG(tooltip)
        self.label_6.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.label_6.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Seashell Mansion prizes can contain progress items", None))
#endif // QT_CONFIG(whatsthis)
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"  Max Seashells: 0", None))
#if QT_CONFIG(tooltip)
        self.heartsCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.heartsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether heart pieces can be progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.tradeGiftsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the trading quest gifts can contain progress items<br></br><u>Not yet implemented</u>", None))
#endif // QT_CONFIG(whatsthis)
        self.tradeGiftsCheck.setText(QCoreApplication.translate("MainWindow", u"Trade Gifts", None))
#if QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.shopCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the shop can contain progress items<br></br><u>Not yet implemented</u>", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.instrumentCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether instruments can be randomized<br></br><u>If this is not checked, it will not be randomized,</u>", None))
#endif // QT_CONFIG(whatsthis)
        self.instrumentCheck.setText(QCoreApplication.translate("MainWindow", u"Instruments", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Extra Options", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.bombsCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.bombsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Bombs can be bought from the shop at the start, otherwise needs Conch Horn", None))
#endif // QT_CONFIG(whatsthis)
        self.bombsCheck.setText(QCoreApplication.translate("MainWindow", u"Unlocked Bombs", None))
#if QT_CONFIG(tooltip)
        self.trendyCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.trendyCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Gives the final Trendy reward from getting the Bow-Wow Figure", None))
#endif // QT_CONFIG(whatsthis)
        self.trendyCheck.setText(QCoreApplication.translate("MainWindow", u"Fast Trendy", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.lessFishingCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lessFishingCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Only shuffles the orange fish, green fish, and Bottle. Beginner friendly", None))
#endif // QT_CONFIG(whatsthis)
        self.lessFishingCheck.setText(QCoreApplication.translate("MainWindow", u"Less Fishing", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.lensCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lensCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Enables shuffle of the Magnifying Lens as well as Goriya Trader and Invisible Zora", None))
#endif // QT_CONFIG(whatsthis)
        self.lensCheck.setText(QCoreApplication.translate("MainWindow", u"Shuffle Lens", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.kanaletCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Sets the Kanalet Gate to be open from the start<br></br>Also temporarily makes the bridge already built", None))
#endif // QT_CONFIG(whatsthis)
        self.kanaletCheck.setText(QCoreApplication.translate("MainWindow", u"Open Kanalet", None))
#if QT_CONFIG(tooltip)
        self.songs_Check.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.songs_Check.setWhatsThis(QCoreApplication.translate("MainWindow", u"Skips the song learning animations and instead just immediately gives the item", None))
#endif // QT_CONFIG(whatsthis)
        self.songs_Check.setText(QCoreApplication.translate("MainWindow", u"Fast Songs", None))
