...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.shuffledBombsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"You need to find your bombs before you can obtain any from other means", None))
#endif // QT_CONFIG(whatsthis)
