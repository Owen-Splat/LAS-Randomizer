...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QRect(-1, 230, 731, 121))
        font3 = QFont()
        ...
        self.dampeCheck.setGeometry(QRect(10, 64, 173, 21))
        self.dampeCheck.setFont(font)
        self.dungeonsCheck = QCheckBox(self.groupBox)
        self.dungeonsCheck.setObjectName(u"dungeonsCheck")
        self.dungeonsCheck.setGeometry(QRect(189, 64, 173, 21))
        self.dungeonsCheck.setFont(font)
        ...
        self.dampeTEMPCheck = QCheckBox(self.tab_4)
        self.dampeTEMPCheck.setObjectName(u"dampeTEMPCheck")
        self.dampeTEMPCheck.setGeometry(QRect(189, 24, 173, 21))
        font4 = QFont()
        font4.setPointSize(9)
        font4.setStrikeOut(True)
        self.dampeTEMPCheck.setFont(font4)
        self.dampeTEMPCheck.setStyleSheet(u"color: rgb(80, 80, 80);")
        self.dampeTEMPCheck.setCheckable(False)
        ...
        self.leavesCheck = QCheckBox(self.tab_4)
        self.leavesCheck.setObjectName(u"leavesCheck")
        self.leavesCheck.setGeometry(QRect(10, 184, 173, 21))
        self.goalComboBox = QComboBox(self.tab_4)
        ...
        self.goalComboBox.setGeometry(QRect(548, 104, 161, 22))
        ...
        self.badPetsCheck = QCheckBox(self.tab_5)
        self.badPetsCheck.setObjectName(u"badPetsCheck")
        self.badPetsCheck.setGeometry(QRect(548, 24, 173, 21))
        ...
        self.kanaletCheck.setGeometry(QRect(10, 144, 173, 21))
        self.unlockedBombsCheck = QCheckBox(self.tab_5)
        self.unlockedBombsCheck.setObjectName(u"unlockedBombsCheck")
        self.unlockedBombsCheck.setGeometry(QRect(10, 184, 173, 21))
        ...
        self.songsCheck.setGeometry(QRect(548, 64, 173, 21))
        self.songsCheck.setFont(font2)
        self.songsCheck.setCheckable(True)
        self.trapsCheck = QCheckBox(self.tab_5)
        self.trapsCheck.setObjectName(u"trapsCheck")
        self.trapsCheck.setGeometry(QRect(189, 104, 173, 21))
        ...
        self.fastFishingCheck.setGeometry(QRect(369, 64, 173, 21))
        self.mazeCheck = QCheckBox(self.tab_5)
        self.mazeCheck.setObjectName(u"mazeCheck")
        self.mazeCheck.setGeometry(QRect(369, 144, 173, 21))
        ...
        self.bridgeCheck.setGeometry(QRect(189, 144, 173, 21))
        ...
        self.owlsComboBox.setGeometry(QRect(189, 224, 161, 22))
        self.raceCheck = QCheckBox(self.tab_5)
        self.raceCheck.setObjectName(u"raceCheck")
        self.raceCheck.setGeometry(QRect(548, 104, 173, 21))
        ...
        self.listWidget_5.setGeometry(QRect(20, 41, 256, 430))
        ...
        self.includeButton_3.setGeometry(QRect(325, 265, 101, 81))
        font6 = QFont()
        font6.setPointSize(11)
        font6.setBold(False)
        self.includeButton_3.setFont(font6)
        ...
        self.excludeButton_3.setGeometry(QRect(325, 165, 101, 81))
        self.excludeButton_3.setFont(font6)
        ...
        self.listWidget_6.setGeometry(QRect(475, 41, 256, 430))
        ...
        self.instrumentsComboBox.setGeometry(QRect(288, 81, 171, 22))
        self.instrumentsComboBox.setEditable(False)
        self.label_14 = QLabel(self.tab_6)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(295, 380, 161, 81))
        ...
        self.label_11.setGeometry(QRect(295, 380, 161, 81))
...
#if QT_CONFIG(whatsthis)
        self.miscellaneousCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether miscellaneous standing items (sword, mushroom, ocarina, slime key, bird key, lens) can be progress items<br></br><u>If this is not checked, it will still be randomized,</u> but will only contain optional items", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.dampeCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Damp\u00e9 prizes can be progress items<br></br><u>This is still likely broken,</u> no logic for instrument shuffle and progressive items may not work", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.dungeonsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Dungeon Entrances will be randomized. Back entrances are vanilla<br></br>Currently only has Basic Logic", None))
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(tooltip)
        self.dampeTEMPCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.dampeTEMPCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Damp\u00e9 prizes can be progress items<br></br><u>The logic is not written to work with instrument shuffle,</u> and may result in unbeatable seeds", None))
#endif // QT_CONFIG(whatsthis)
        self.dampeTEMPCheck.setText(QCoreApplication.translate("MainWindow", u"Damp\u00e9", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.trapsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Adds various traps to the item pool, which can be disguised as other items", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.enemyCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Randomizes enemy actors. Currently no logic, needed kills are left vanilla<br></br><u>This is in the very early stages,</u> and as such things may break", None))
#endif // QT_CONFIG(whatsthis)
