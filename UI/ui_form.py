...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_5.setGeometry(QRect(10, 130, 521, 141))
        ...
        self.extendedConsumableCheck.setGeometry(QRect(10, 104, 151, 21))
        ...
        self.groupBox_7.setGeometry(QRect(540, 130, 181, 141))
        ...
        self.songsCheck.setGeometry(QRect(10, 24, 151, 21))
        ...
        self.stealingCheck.setGeometry(QRect(10, 64, 151, 21))
        ...
        self.trapsComboBox.setGeometry(QRect(10, 100, 161, 22))
        ...
        self.rupeesSpinBox.setFont(font7)
        ...
        self.randomizeButton.setGeometry(QRect(630, 561, 121, 41))
        ...
        self.resetButton.setGeometry(QRect(20, 561, 121, 41))
        ...
        self.explainationLabel.setGeometry(QRect(30, 509, 711, 41))
        ...
        self.lineEdit_4.setGeometry(QRect(150, 560, 471, 23))
        self.lineEdit_4.setFont(font1)
        self.externalSettingsCheck = QCheckBox(self.centralwidget)
        self.externalSettingsCheck.setObjectName(u"externalSettingsCheck")
        self.externalSettingsCheck.setEnabled(True)
        self.externalSettingsCheck.setGeometry(QRect(160, 590, 161, 21))
        self.externalSettingsCheck.setFont(font2)
        self.externalSettingsCheck.setCheckable(True)
        self.browseButton3 = QPushButton(self.centralwidget)
        self.browseButton3.setObjectName(u"browseButton3")
        self.browseButton3.setGeometry(QRect(530, 590, 75, 23))
...
# endif // QT_CONFIG(whatsthis)
        self.extendedConsumableCheck.setText(QCoreApplication.translate("MainWindow", u"New consumable drop", None))
#if QT_CONFIG(tooltip)
        ...
        self.groupBox_8.setTitle(QCoreApplication.translate("MainWindow", u"Gameplay", None))
#if QT_CONFIG(whatsthis)
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_7), QCoreApplication.translate("MainWindow", u"Patches", None))
...
#if QT_CONFIG(tooltip)
        self.externalSettingsCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.externalSettingsCheck.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.externalSettingsCheck.setText(QCoreApplication.translate("MainWindow", u"Use external settings file", None))
