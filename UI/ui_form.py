...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.raceCheck = QCheckBox(self.groupBox)
        self.raceCheck.setObjectName(u"raceCheck")
        self.raceCheck.setGeometry(QRect(10, 44, 173, 21))
        self.raceCheck.setFont(font)
        self.trendyCheck = QCheckBox(self.groupBox)
        self.trendyCheck.setObjectName(u"trendyCheck")
        self.trendyCheck.setEnabled(True)
        self.trendyCheck.setGeometry(QRect(369, 44, 173, 21))
        self.trendyCheck.setFont(font2)
        ...
        self.seashellsCheck.setGeometry(QRect(548, 44, 173, 21))
        self.seashellsCheck.setFont(font2)
        self.seashellsCheck.setCheckable(False)
        self.dampeCheck = QCheckBox(self.groupBox)
        self.dampeCheck.setObjectName(u"dampeCheck")
        self.dampeCheck.setGeometry(QRect(189, 44, 173, 21))
        ...
        self.shopCheck.setGeometry(QRect(10, 84, 173, 21))
        self.shopCheck.setFont(font2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.owlsComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Owl Statues: Hints", None))
        self.owlsComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Owl Statues: Gifts", None))
        self.owlsComboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Owl Statues: Hybrid", None))
