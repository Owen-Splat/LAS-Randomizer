...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(10, 10, 760, 491))
        ...
        self.tabWidget_2.setGeometry(QRect(10, 104, 733, 350))
        self.tab_4 = QWidget()
        self.tab_4.setObjectName(u"tab_4")
        self.groupBox = QGroupBox(self.tab_4)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(10, 14, 531, 141))
        ...
        self.tradeGiftsCheck.setGeometry(QRect(369, 24, 151, 21))
        font2 = QFont()
        ...
        self.seashellsCheck.setGeometry(QRect(369, 64, 151, 21))
        font3 = QFont()
        ...
        self.groupBox_2.setGeometry(QRect(550, 14, 171, 141))
        ...
        self.groupBox_3.setGeometry(QRect(10, 169, 351, 101))
        ...
        self.groupBox_4.setGeometry(QRect(539, 169, 181, 101))
        self.groupBox_4.setAlignment(Qt.AlignHCenter|Qt.AlignTop)
        self.seashellsComboBox = QComboBox(self.groupBox_4)
        ...
        self.seashellsComboBox.setGeometry(QRect(10, 24, 161, 22))
        self.seashellsComboBox.setEditable(False)
        self.goalComboBox = QComboBox(self.groupBox_4)
        ...
        self.goalComboBox.addItem("")
        self.goalComboBox.addItem("")
        self.goalComboBox.setObjectName(u"goalComboBox")
        self.goalComboBox.setEnabled(False)
        self.goalComboBox.setGeometry(QRect(10, 64, 161, 22))
        self.goalComboBox.setFont(font3)
        self.goalComboBox.setEditable(False)
        self.tabWidget_2.addTab(self.tab_4, "")
        self.tab_5 = QWidget()
        self.tab_5.setObjectName(u"tab_5")
        self.groupBox_6 = QGroupBox(self.tab_5)
        self.groupBox_6.setObjectName(u"groupBox_6")
        self.groupBox_6.setGeometry(QRect(10, 14, 711, 101))
        self.groupBox_6.setAlignment(Qt.AlignHCenter|Qt.AlignTop)
        self.bridgeCheck = QCheckBox(self.groupBox_6)
        self.bridgeCheck.setObjectName(u"bridgeCheck")
        self.bridgeCheck.setGeometry(QRect(10, 24, 151, 21))
        self.swampCheck = QCheckBox(self.groupBox_6)
        self.swampCheck.setObjectName(u"swampCheck")
        self.swampCheck.setGeometry(QRect(189, 24, 151, 21))
        self.swampCheck.setFont(font2)
        self.swampCheck.setCheckable(True)
        self.musicCheck = QCheckBox(self.groupBox_6)
        self.musicCheck.setObjectName(u"musicCheck")
        self.musicCheck.setEnabled(True)
        self.musicCheck.setGeometry(QRect(369, 64, 151, 21))
        ...
        self.enemyCheck.setGeometry(QRect(369, 24, 151, 21))
        self.enemyCheck.setFont(font2)
        self.enemyCheck.setCheckable(True)
        self.kanaletCheck = QCheckBox(self.groupBox_6)
        self.kanaletCheck.setObjectName(u"kanaletCheck")
        self.kanaletCheck.setGeometry(QRect(10, 64, 151, 21))
        self.mazeCheck = QCheckBox(self.groupBox_6)
        self.mazeCheck.setObjectName(u"mazeCheck")
        self.mazeCheck.setGeometry(QRect(189, 64, 151, 21))
        self.mazeCheck.setFont(font2)
        self.mazeCheck.setCheckable(True)
        self.chestSizesCheck = QCheckBox(self.groupBox_6)
        self.chestSizesCheck.setObjectName(u"chestSizesCheck")
        self.chestSizesCheck.setEnabled(True)
        self.chestSizesCheck.setGeometry(QRect(548, 24, 151, 21))
        self.chestSizesCheck.setFont(font2)
        self.chestSizesCheck.setCheckable(True)
        ...
        self.farmingCheck = QCheckBox(self.groupBox_5)
        self.farmingCheck.setObjectName(u"farmingCheck")
        self.farmingCheck.setGeometry(QRect(10, 104, 151, 21))
        ...
        self.groupBox_7.setGeometry(QRect(550, 130, 171, 181))
        self.groupBox_7.setAlignment(Qt.AlignHCenter|Qt.AlignTop)
        self.songsCheck = QCheckBox(self.groupBox_7)
        ...
        self.trapsCheck = QCheckBox(self.groupBox_7)
        self.trapsCheck.setObjectName(u"trapsCheck")
        self.trapsCheck.setGeometry(QRect(10, 144, 151, 21))
        self.spoilerCheck = QCheckBox(self.groupBox_7)
        ...
        self.stealingCheck = QCheckBox(self.groupBox_7)
        self.stealingCheck.setObjectName(u"stealingCheck")
        self.stealingCheck.setGeometry(QRect(10, 104, 151, 21))
        ...
        self.listWidget_5.setGeometry(QRect(20, 41, 256, 408))
        ...
        self.listWidget_6.setGeometry(QRect(475, 41, 256, 408))
        ...
        self.instrumentsComboBox.setGeometry(QRect(288, 59, 171, 22))
        self.instrumentsComboBox.setEditable(False)
        self.label_14 = QLabel(self.tab_6)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(295, 358, 161, 81))
        sizePolicy2.setHeightForWidth(self.label_14.sizePolicy().hasHeightForWidth())
        self.label_14.setSizePolicy(sizePolicy2)
        self.label_14.setMinimumSize(QSize(75, 23))
        font6 = QFont()
        ...
        self.listWidget.setGeometry(QRect(20, 41, 256, 408))
        ...
        self.listWidget_2.setGeometry(QRect(475, 41, 256, 408))
        ...
        self.listWidget_4.setGeometry(QRect(475, 41, 256, 301))
        ...
        self.listWidget_3.setGeometry(QRect(20, 41, 256, 301))
        ...
        self.label_11.setGeometry(QRect(295, 248, 161, 81))
        ...
        self.groupBox_8.setGeometry(QRect(20, 350, 711, 101))
        self.groupBox_8.setAlignment(Qt.AlignCenter)
        self.logicCheck = QCheckBox(self.groupBox_8)
        self.logicCheck.setObjectName(u"logicCheck")
        self.logicCheck.setEnabled(True)
        self.logicCheck.setGeometry(QRect(10, 24, 151, 21))
        self.logicCheck.setFont(font2)
        self.logicCheck.setCheckable(True)
        self.lineEdit_4 = QLineEdit(self.groupBox_8)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(110, 64, 501, 23))
        self.lineEdit_4.setFont(font1)
        self.lineEdit_4.setReadOnly(True)
        self.browseButton3 = QPushButton(self.groupBox_8)
        self.browseButton3.setObjectName(u"browseButton3")
        self.browseButton3.setEnabled(True)
        self.browseButton3.setGeometry(QRect(626, 64, 75, 23))
        ...
        self.label_4.setGeometry(QRect(10, 64, 91, 23))
        ...
        self.randomizeButton.setGeometry(QRect(620, 561, 131, 41))
        self.randomizeButton.setFont(font5)
        ...
        self.resetButton.setGeometry(QRect(20, 561, 131, 41))
        ...
        self.updateChecker.setGeometry(QRect(179, 561, 421, 41))
        font7 = QFont()
        ...
        self.explainationLabel.setGeometry(QRect(30, 509, 581, 41))
        ...
        self.goalComboBox.setCurrentIndex(8)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.dampeCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Damp\u00e9 prizes can be progress items<br></br><u>The logic does not work with instrument shuffle,</u> and may permanently remove items", None))
#endif // QT_CONFIG(whatsthis)
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("MainWindow", u"Goals", None))
        ...
        self.goalComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"Required Instruments:  0", None))
        self.goalComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Required Instruments:  1", None))
        self.goalComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Required Instruments:  2", None))
        self.goalComboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Required Instruments:  3", None))
        self.goalComboBox.setItemText(4, QCoreApplication.translate("MainWindow", u"Required Instruments:  4", None))
        self.goalComboBox.setItemText(5, QCoreApplication.translate("MainWindow", u"Required Instruments:  5", None))
        self.goalComboBox.setItemText(6, QCoreApplication.translate("MainWindow", u"Required Instruments:  6", None))
        self.goalComboBox.setItemText(7, QCoreApplication.translate("MainWindow", u"Required Instruments:  7", None))
        ...
        self.groupBox_6.setTitle(QCoreApplication.translate("MainWindow", u"World Options", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.enemyCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Randomizes enemies that do not affect logic. Needed kills are left vanilla", None))
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(tooltip)
        self.chestSizesCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.chestSizesCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Sets chest sizes to match the importance of the item", None))
#endif // QT_CONFIG(whatsthis)
        self.chestSizesCheck.setText(QCoreApplication.translate("MainWindow", u"Scaled Chests", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.badPetsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Companions will follow you into dungeons<br></br>There is currently no logic for this setting", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.fastTrendyCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Gives the final Trendy reward from getting the CiaoCiao Figure<br></br>This check does not change whether the final prize is included or not", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.farmingCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Reduces time spent grinding money and resources", None))
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(tooltip)
        self.trapsCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.trapsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Adds various traps to the item pool, which can be disguised as other items<br></br><u>If this is not checked,</u> only the vanilla zol traps are included", None))
#endif // QT_CONFIG(whatsthis)
        self.trapsCheck.setText(QCoreApplication.translate("MainWindow", u"Trapsanity", None))
#if QT_CONFIG(tooltip)
        ...
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"Not fully tested<br></br><br></br>Mainly functional, may have some issues", None))
...
#endif // QT_CONFIG(whatsthis)
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Not complete<br></br><br></br>Refer to the README for info on the current logic", None))
        self.groupBox_8.setTitle(QCoreApplication.translate("MainWindow", u"Custom Logic", None))
#if QT_CONFIG(tooltip)
        self.logicCheck.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.logicCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether instruments will be randomized<br></br><u>If this is not checked, it will not be randomized,</u> except for the instruments you start with", None))
#endif // QT_CONFIG(whatsthis)
        self.logicCheck.setText(QCoreApplication.translate("MainWindow", u"Use Custom Logic", None))
        self.lineEdit_4.setText("")
        self.browseButton3.setText(QCoreApplication.translate("MainWindow", u"Browse", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Logic File Path", None))
