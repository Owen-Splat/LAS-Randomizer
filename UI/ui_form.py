...
################################################################################
## Form generated from reading UI file 'ui_test_form.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.seashellsCheck.setGeometry(QRect(548, 64, 173, 21))
        font3 = QFont()
        ...
        self.label_6.setGeometry(QRect(548, 104, 111, 23))
        ...
        self.horizontalSlider.setGeometry(QRect(548, 144, 111, 22))
        font4 = QFont()
        ...
        self.instrumentsComboBox.setGeometry(QRect(369, 144, 161, 22))
        ...
        self.rupCheck.setGeometry(QRect(10, 144, 173, 21))
        ...
        self.tunicsCheck.setGeometry(QRect(369, 104, 173, 21))
        ...
        self.loadingCheck.setGeometry(QRect(189, 144, 173, 21))
        self.loadingCheck.setFont(font3)
        ...
        self.kanaletCheck.setGeometry(QRect(10, 104, 173, 21))
        ...
        self.songsCheck.setGeometry(QRect(189, 104, 173, 21))
        self.songsCheck.setFont(font3)
        ...
        self.spoilerCheck.setGeometry(QRect(548, 144, 173, 21))
        ...
        self.label_11.setGeometry(QRect(290, 41, 171, 30))
        ...
        self.horizontalSlider_2.setGeometry(QRect(290, 80, 171, 22))
        self.horizontalSlider_2.setFont(font4)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.instrumentCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether instruments will be randomized<br></br><u>If this is not checked, it will not be randomized,</u>", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.dampeCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether the Damp\u00e9 prizes can be progress items<br></br><u>This is very broken right now,</u> and is recommended to turn off until fixed", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.label_6.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls the maximum number of seashells to be considered in logic for the Seashell Mansion prizes", None))
#endif // QT_CONFIG(whatsthis)
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"  Max Seashells: 0", None))
#if QT_CONFIG(whatsthis)
        self.horizontalSlider.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls the maximum number of seashells to be considered in logic for the Seashell Mansion prizes", None))
#endif // QT_CONFIG(whatsthis)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.label_11.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls what logic preset to use", None))
#endif // QT_CONFIG(whatsthis)
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"    Preset:  Glitched (Advanced)", None))
#if QT_CONFIG(whatsthis)
        self.horizontalSlider_2.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls what logic preset to use", None))
#endif // QT_CONFIG(whatsthis)
