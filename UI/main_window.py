...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def parseExternalSettings(self):
        ...
        try:
            ...
            settings = {
                ...
                'extended-consumable-drop': external_settings['Extended_Consumable_Drop'],
                ...
                'chest-aspect': external_settings['Chest_Aspect'],
    ...
    def randomizeButton_Clicked(self):
        ...
        settings = {
            ...
            'extended-consumable-drop': self.ui.extendedConsumableCheck.isChecked(),
            ...
            'chest-aspect': CHEST_ASPECT_SETTINGS[self.ui.chestAspectComboBox.currentIndex()],
