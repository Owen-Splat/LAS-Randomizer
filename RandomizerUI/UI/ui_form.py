...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_5.setGeometry(QRect(10, 169, 521, 170))
        ...
        self.quickModeCheck = QCheckBox(self.groupBox_8)
        self.quickModeCheck.setObjectName(u"quickModeCheck")
        self.quickModeCheck.setGeometry(QRect(368, 24, 151, 21))
...
#if QT_CONFIG(whatsthis)
        self.quickModeCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Disables boss intros and Power/Defense up text boxes, skips some animations to make the game quicker<br><b>/!\\ WIP: This is still in testing phase and might break your seed ! Feedbacks would be appreciated !</b>", None))
#endif // QT_CONFIG(whatsthis)
        self.quickModeCheck.setText(QCoreApplication.translate("MainWindow", u"WIP : Quick Mode", None))
